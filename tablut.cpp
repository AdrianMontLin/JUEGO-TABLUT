...
void turnoJugador(char tablero[filas][columnas], Jugadores t_jugador1, Jugadores t_jugador2, char jugadorActual) {
    ...
    cout << "Turno del jugador " << t_jugador1.nombre << endl;
    ...
    if (esMovimientoValido(tablero, filaOrigen, columnaOrigen, filaDestino, columnaDestino, jugadorActual)) {
        ...
        // Volver a solicitar el movimiento al mismo jugador
    }
}
